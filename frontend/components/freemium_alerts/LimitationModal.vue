<template>
    <Modal :title="modalTitle" size="md" :modelValue="modelValue" :preventClose="preventClose" :hideClose="hideClose"
        @close="handleClose">
        ...
        <template #footer="{ toggleModal }">
            <div class="flex justify-end space-x-3 pt-2">
                <Button v-if="showSecondaryButton" @click="handleSecondaryAction(toggleModal)"
                ...
                <Button color="primary" @click="handlePrimaryAction(toggleModal)" :label="primaryButtonLabel"
