                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative flex h-12 w-12 items-center justify-center">
                            <svg class="h-12 w-12 -rotate-90 transform" viewBox="0 0 36 36">
                                <path class="text-purple-200 dark:text-purple-800" d="M18 2.0845
                                        a 15.9155 15.9155 0 0 1 0 31.831
                                        a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor"
                                    stroke-width="2"></path>
                                <path class="text-gradient-to-r from-pink-500 via-purple-500 to-blue-500"
                                    :class="timeRemaining <= 60 ? 'text-red-500' : 'text-purple-500'" d="M18 2.0845
                                        a 15.9155 15.9155 0 0 1 0 31.831
                                        a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor"
                                    stroke-width="2" :stroke-dasharray="`${timerProgress}, 100`"></path>
                            </svg>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <span class="text-xs font-bold text-purple-700 dark:text-purple-200"> {{
                                    Math.ceil(timeRemaining / 60) }}m </span>
                            </div>
                        </div>
                    </div>
                </div>
