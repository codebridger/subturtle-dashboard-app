    ...
    <Card
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-1 items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="h-2 w-12 rounded-full bg-purple-200/60 shadow-inner dark:bg-purple-800/60">
                        <div class="h-full rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 shadow-sm transition-all duration-500 ease-out"
            ...
            <div class="flex items-center">
                <Button color="primary" size="md" @click="handleAction" :iconName="isAtLimit ? 'IconCrown' : actionIcon"
