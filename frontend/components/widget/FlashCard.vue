                ...
                <div class="flex h-full flex-col">
                    ...
                    <div class="flex w-full items-start justify-between px-6 pt-4">
                        ...
                        <div v-if="isFlipped" class="flex flex-col items-end gap-1">
                            ...
                            <span class="rounded-full border border-gray-300 bg-gray-100 px-3 py-1 text-xs font-bold uppercase text-gray-700">
                        ...
                        <div class="relative flex h-full w-full flex-col items-center justify-center">
                            ...
                            <div class="flex w-full items-start justify-between px-6 pt-4">
                                <div class="flex min-w-0 flex-col items-start gap-1">
                                    <template v-if="phraseType === 'linguistic' && (props.linguisticData?.type || props.linguisticData?.formality_level)">
                                ...
                                <div class="flex flex-col items-end gap-1">
                                    <div class="mb-0.5 pr-0.5 text-[10px] text-gray-400">Language</div>
                                    <span class="rounded-full border border-gray-300 bg-gray-100 px-3 py-1 text-xs font-bold uppercase text-gray-700">
                                        {{ phraseType === 'linguistic' ? props.languageInfo?.target || 'TRG' : props.translationLanguage || 'LANG' }}
                                    </span>
                                </div>
                            </div>
