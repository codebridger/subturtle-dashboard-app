<template>
    <div class="max-w-3xl p-4">
        ...
        <!-- Cost Information -->
        <div v-if="session?.cost && config.public.isNotProduction"
            class="mb-6 rounded-lg bg-white p-4 shadow dark:bg-gray-800">
        ...
        <!-- Dialog Messages -->
        <div class="space-y-4">
            <div v-for="dialog in session?.dialogs" :key="dialog.id"
                ...
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0">
                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900">
                            <Icon :name="dialog.speaker === 'user' ? 'IconUser' : 'IconRobot'"
