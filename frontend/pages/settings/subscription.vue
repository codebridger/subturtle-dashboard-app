            ...
            <div class="flex w-4/5 flex-col gap-4">
                ...
                <div class="mx-auto mt-8 max-w-full dark:text-white-dark">
                    <div class="justify-between space-y-8 md:flex md:space-x-4 md:space-y-0 rtl:space-x-reverse">
                        ...
                        <Card class="group w-full rounded border border-[#e0e6ed] !p-0 shadow-none transition-all duration-300 dark:border-[#1b2e4b]">
                            <div class="border-b border-[#e0e6ed] p-5 pt-0 dark:border-[#1b2e4b]">
                                <span
                                    ...
                                    >£0</span
                                >
                                <h3 class="mb-2.5 mt-4 text-xl lg:text-2xl">{{ t('subscription.freemium') }}</h3>
                            ...
                            <div class="p-5">
                                <ul class="mb-5 space-y-2.5 font-semibold">
                                    <li class="flex items-start">
                                        ...
                                        <span>{{ t('subscription.credits') }}: 500</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="iconify mr-3 mt-1 text-xl text-blue-600 solar--check-circle-bold"></span>
                                        <span>{{ t('subscription.duration') }}: 30 {{ t('subscription.days') }}</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="iconify mr-3 mt-1 text-xl text-blue-600 solar--check-circle-bold"></span>
                                ...
                                <Button class="btn btn-primary hidden w-full" disabled>
                        ...
                        <Card class="group w-full rounded border border-[#e0e6ed] !p-0 shadow-none transition-all duration-300 dark:border-[#1b2e4b]">
                            <div class="border-b border-[#e0e6ed] p-5 pt-0 dark:border-[#1b2e4b]">
                                <span
                                    ...
                                    >£7.6</span
                                >
                                <h3 class="mb-2.5 mt-4 text-xl lg:text-2xl">{{ t('subscription.premium') }}</h3>
                                <p class="text-[15px]">{{ t('subscription.monthly-description') }}</p>
                            </div>
                            <div class="p-5">
                                <ul class="mb-5 space-y-2.5 font-semibold">
                                    <li class="flex items-start">
                                        <span class="iconify mr-3 mt-1 text-xl text-blue-600 solar--check-circle-bold"></span>
                                        <span>{{ t('subscription.credits') }}: 1000</span>
                                    </li>
                                    <li class="flex items-start">
                                    ...
                                    <li class="flex items-start">
                                        ...
                                        <span>Auto Lecture Generator</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="iconify mr-3 mt-1 text-xl text-blue-600 solar--phone-calling-rounded-bold"></span>
                                        <span>AI coach on Telegram with Call</span>
                                    </li>
                                </ul>
                                <Button @click="initiateCheckout" class="btn btn-primary block w-full" :disabled="isLoading">
